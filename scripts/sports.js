...
document.getElementById('gaby-cornier').addEventListener('click', function() {
    const myArticle = {
        ...
        about_two_es: "",
        date: "", 
        desc_en: "The Florida volleyball team was gearing up to play its first home match of the season, and all Gaby Cornier envisioned were the young girls of Puerto Rico watching her.",
        desc_es: "El equipo de voleibol de Florida se estaba preparando para jugar su primer partido en casa de la temporada, y todo lo que Cornier imaginaba eran las jóvenes de Puerto Rico mirándola.",
